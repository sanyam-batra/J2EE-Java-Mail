...
@WebServlet(urlPatterns = {"/selectfolder"})
...
out.println("<html><BODY BGCOLOR=AQUA><form action='http://localhost:8080/WebApplication1/deletemail' method=post><h2>Welcome <FONT COLOR=PINK>"+una+"@QuickMail.com </FONT></h2>");
		...
		while(rs.next())
		 {	
			...
			out.println("<TD width=200 align=center><A href=http://localhost:8080/WebApplication1/getmsg?msgf="+from+"&msgd="+dat+" target=rightf>"+from+"</A>");
